      ...
      <v-col cols="12" md="6">
        ...
        <ul id="l1">
          <li data-list-text="">
            <p style="padding-left: 43pt;text-indent: -18pt;text-align: left;"><a href="https://www.firansefood.com/"
                class="s2" target="_blank">Visit our website at </a><a href="http://www.cityfood.ng/" class="a"
        ...
        <ol id="l2">
          <li data-list-text="1.">
            ...
            <p style="padding-top: 8pt;padding-left: 6pt;text-indent: 0pt;text-align: justify;">We collect personal
            ...
            <p style="padding-top: 1pt;padding-left: 6pt;text-indent: 0pt;text-align: left;">addresses; usernames;
              passwords; contact preferences; debit/credit card numbers; and other similar information.</p>
            <h3 style="padding-top: 3pt;padding-left: 6pt;text-indent: 0pt;text-align: justify;">Payment Data. <a
                href="https://www.flutterwave.com/privacy-policy" class="s2" target="_blank">We may collect data
                necessary
            ...
            <p style="padding-top: 8pt;padding-left: 10pt;text-indent: 0pt;line-height: 162%;text-align: left;">Like
              many
              businesses, we also collect information through cookies and similar technologies. The information we
              collect
              includes:</p>
            <ul id="l3">
              <li data-list-text="">
                <p class="s4" style="padding-left: 43pt;text-indent: -18pt;text-align: left;">Log and Usage Data. <span
                    class="p">Log and usage data are service-related, diagnostic, usage and performance information our
                    ...
                    stamps associated with your usage, pages and files viewed, searches and other actions you take such
                    as
              ...
              <li data-list-text="">
                <p class="s4" style="padding-left: 43pt;text-indent: -18pt;text-align: left;">Device Data. <span
                    class="p">We collect device data such as information about your computer, phone, tablet or other
                    device
                    you use to access the Services. Depending on the device used, this device data may include
                    information
                    such as your IP address (or proxy server), device and App/Website/Web App identification numbers,
              ...
              <li data-list-text="">
                <p class="s4" style="padding-left: 43pt;text-indent: -18pt;text-align: left;">Location Data. <span
                    class="p">We collect location data such as information about your device&#39;s location, which can
                    be
              ...
              <li data-list-text="">
                <p class="s4" style="padding-left: 43pt;text-indent: -18pt;text-align: left;">Geolocation Information.
                  <span class="p">We may request access or permission to and track location-based information from your
                    mobile
                    device, either continuously or while you are using our App/Website/Web App, to provide certain
              ...
              <li data-list-text="">
                <p class="s4" style="padding-left: 43pt;text-indent: -18pt;text-align: left;">Push Notifications. <span
                    class="p">We may request to send you push notifications regarding your account or certain features
                    of
                    the App/Website/Web App. If you wish to opt-out from receiving these types of communications, you
                    may
            ...
            <ul id="l4">
              <li data-list-text="">
                <h3 style="padding-left: 43pt;text-indent: -18pt;text-align: left;">To facilitate account creation and
                  login
                  process. <span class="p">If you choose to link your account with us to a third-party account (such as
                    your
              ...
              <li data-list-text="">
                <h3 style="padding-left: 43pt;text-indent: -18pt;text-align: left;">To post testimonials. <a
                    href="mailto:firansefood@gmail.com" class="s2" target="_blank">We post testimonials on our Services
                    that
                    may contain personal information. Prior to posting a testimonial, we will obtain your consent to use
                    your name and the content of the testimonial. If you wish to update, or delete your testimonial,
                    please
                    contact us at </a><span
                    style=" color: #0462C1; font-family:&quot;Times New Roman&quot;, serif; font-style: normal; font-weight: normal; text-decoration: underline; font-size: 11.5pt;">firansefood@gmail.com</span><span
              ...
              <li data-list-text="">
                <h3 style="padding-left: 43pt;text-indent: -18pt;text-align: left;">Request feedback. <span class="p">We
                    may
                    use your information to request feedback and to contact you about your use of our Services.</span>
                </h3>
              </li>
              <li data-list-text="">
                <h3 style="padding-top: 3pt;padding-left: 43pt;text-indent: -18pt;text-align: left;">To enable
                  user-to-user
              ...
              <li data-list-text="">
                <h3 style="padding-left: 43pt;text-indent: -18pt;text-align: left;">Administer prize draws and
                  competitions.
                  <span class="p">We may use your information to administer prize draws and competitions when you elect
                    to
              ...
              <li data-list-text="">
                <h3 style="padding-left: 43pt;text-indent: -18pt;text-align: left;">To send you marketing and
                  promotional
                  communications. <span class="p">We and/or our third-party marketing partners may use the personal
              ...
              <li data-list-text="">
                <h3 style="padding-left: 43pt;text-indent: -18pt;text-align: left;">Deliver targeted advertising to you.
                  <span class="p">We may use your information to develop and display personalized content and
                    advertising
                    (and work with third parties who do so) tailored to your interests and/or location and to measure
                    its
                    effectiveness.</span>
                </h3>
                <p style="text-indent: 0pt;text-align: left;"><br /></p>
              ...
              <li data-list-text="">
                <h3 style="padding-left: 43pt;text-indent: -18pt;text-align: left;">For other business purposes. <span
                    class="p">We may use your information for other business purposes, such as data analysis,
                    identifying
          ...
          <li data-list-text="3.">
            ...
            <h2 style="padding-left: 6pt;text-indent: -1pt;text-align: left;">In Short: <span class="s4">We only share
                ...
                rights, or
                to fulfil business obligations.</span></h2>
            ...
            <ul id="l5">
              ...
              <li data-list-text="">
                <h3 style="padding-left: 43pt;text-indent: -18pt;text-align: left;">Vital Interests: <span class="p">We
                    may
                    disclose your information where we believe it is necessary to investigate, prevent, or take action
                    regarding potential violations of our policies, suspected fraud, situations involving potential
                    threats
              ...
              <li data-list-text="">
                <h3 style="padding-left: 43pt;text-indent: -18pt;text-align: left;">Google Maps Platform APIs. <a
                    href="https://policies.google.com/privacy" class="s2" target="_blank">We may share your information
                    with
                    certain Google Maps Platform APIs (e.g., Google Maps API, Place API). To find out more about
                    Google’s
                    Privacy Policy, please refer to this </a><a href="https://policies.google.com/privacy" class="s1"
                    target="_blank">link</a><span class="p">. We obtain and store on your device (&#39;cache&#39;) your
              ...
              <li data-list-text="">
                <h3 style="padding-left: 43pt;text-indent: -18pt;text-align: left;">Offer Wall. <span class="p">Our
                    App/Website/Web App may display a third-party hosted &quot;offer wall.&quot; Such an offer wall
                    allows
                    third-party advertisers to offer virtual currency, gifts, or other items to users in return for the
                    acceptance and completion of an advertisement offer. Such an offer wall may appear in our
                    App/Website/Web App and be displayed to you based on certain data, such as your geographic area or
                    demographic information. When you click on an offer wall, you will be brought to an external website
                    belonging to other persons and will leave our App/Website/Web App. A unique identifier, such as your
                    user ID, will be shared with the offer wall provider in order to prevent fraud and properly credit
                    your
                    account with the relevant reward. Please note that we do not control third-party websites and have
                    no
                    responsibility in relation to the content of such websites. The inclusion of a link towards a
                    third-party website does not imply an endorsement by us of such website. Accordingly, we do not make
                    any
                    warranty regarding such third-party websites and we will not be liable for any loss or damage caused
                    by
                    the use of such websites. In addition, when you access any third-party website, please understand
                    that
                    your rights while accessing and using those websites will be governed by the privacy notice and
                    terms of
                    service relating to the use of those websites.</span></h3>
              </li>
            </ul>
          </li>
          <li data-list-text="4.">
          ...
          <li data-list-text="5.">
            ...
            <p style="padding-left: 6pt;text-indent: 0pt;text-align: left;">Our Services offers you the ability to
              ...
              Where
              you choose to do this, we will receive certain profile information about you from your social media
              provider.
              The profile information we receive may vary depending on the social media provider concerned, but will
              often
            ...
            <p style="padding-left: 6pt;text-indent: 0pt;text-align: left;">We will use the information we receive only
              ...
              relevant
              Services. Please note that we do not control, and are not responsible for, other uses of your personal
              information by your third-party social media provider. We recommend that you review their privacy notice
              to
            ...
            <ul id="l6">
              ...
              <li data-list-text="">
                <p style="padding-left: 43pt;text-indent: -18pt;text-align: left;">Contact us using the contact
                  information
                  provided.</p>
                <p style="padding-top: 11pt;padding-left: 6pt;text-indent: 0pt;text-align: left;">Upon your request to
                  terminate your account, we will deactivate or delete your account and information from our active
                ...
                <p class="s8" style="padding-left: 6pt;text-indent: 0pt;text-align: left;">Cookies and similar
                  technologies:<span class="h3"> </span><span class="p">Most Web browsers are set to accept cookies by
                    ...
                    services of our Services.</span></p>
                <p class="s8" style="padding-top: 8pt;padding-left: 6pt;text-indent: 0pt;text-align: left;">Opting out
                  of
                  email marketing:<span class="h3"> </span><span class="p">You can unsubscribe from our marketing email
                    list
                    at any time by clicking on the unsubscribe link in the emails that we send or by contacting us using
                    the
                    details</span></p>
                <p style="padding-top: 3pt;padding-left: 6pt;text-indent: 0pt;text-align: left;">provided below. You
                  will
                  then be removed from the marketing email list — however, we may still communicate with you, for
                  example to
        ...
        <ol id="l7">
          <li data-list-text="10.">
            ...
            <p style="padding-left: 6pt;text-indent: 0pt;text-align: left;">Most web browsers and some mobile operating
              ...
              collected. At this stage no uniform technology standard for recognizing and implementing DNT signals has
              been
          ...
          <li data-list-text="11.">
            ...
            <p style="padding-left: 6pt;text-indent: 0pt;text-align: left;">We may update this privacy notice from time
              ...
              will be effective as soon as it is accessible. If we make material changes to this privacy notice, we may
          ...
          <li data-list-text="12.">
            ...
            <p style="padding-left: 6pt;text-indent: 0pt;text-align: left;"><a href="mailto:thenexbuydistrict@gmail.com"
                ...
                style=" color: black; font-family:&quot;Times New Roman&quot;, serif; font-style: normal; font-weight: normal; text-decoration: underline; font-size: 11.5pt;">firansefood@gmail.com</span>
              or by post to:</p>
        ...
        <p class="mt-8" style="padding-top: 7pt;padding-left: 6pt;text-indent: 0pt;text-align: left;"><a
            ...
            please
            submit a request form by sending a mail to </a><a href="mailto:firansefood@gmail.com" class="a"
            target="_blank">firansefood@gmail.com</a><a href="mailto:firansefood@gmail.com" class="s2"
            target="_blank">.</a>
        </p>
        <h3 style="padding-top: 10pt;padding-left: 22pt;text-indent: -15pt;text-align: left;">
          FiranseFood LLC. (Copyright 2022)</h3>
      </v-col>
    </v-row>
  </div>
</template>
